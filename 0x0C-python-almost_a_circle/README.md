...
I incorporated Python object-oriented programming skills in this project by building three related classes to represent rectangles and squares. To verify all functionality for each class, I created my own test suite using the `unittest` module.
